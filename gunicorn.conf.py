...
loglevel: str = str(environ.get("LOG_LEVEL", "debug"))

accesslog: str = "log_access.log"
errorlog: str = "log_errors.log"

reload: bool = bool(environ.get("GUNICORN_RELOAD", 0))

# Тут можно подтюнить, перезагрузка gunicorn worker при request count > max_requests
